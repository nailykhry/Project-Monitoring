        ...
        <form action="{{ route('project.update', $project->id) }}" method="POST" enctype="multipart/form-data">
            ...
            <div class=" form-group">
                ...
                <input type="text" class="form-control" id="project_name" name="project_name" value={{
                    old('project_name', $project->project_name) }} >
            </div>
            ...
            <div class="form-group">
                ...
                <input type="text" class="form-control" id="pl_name" name="pl_name" value={{ old('pl_name',
                    $project->pl_name) }}>
            </div>

            <div class="form-group">
                <label for="pl_email">Project Leader Email</label>
                <input type="email" class="form-control" id="pl_email" name="pl_email" value={{ old('pl_email',
                    $project->pl_email) }}>
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
                ...
                <input type="number" class="form-control" id="progress" aria-describedby="progress" name="progress"
                    value={{ old('progress', $project->progress) }} placeholder="Masukkan sebuah bilangan bulat">
                <small id="progress" class="form-text text-muted">Masukkan bilangan bulat menunjukkan progress dalam
                    persen</small>
            </div>

            <button type="submit" class="float-right mx-3"><i class="bi bi-send-plus"></i>&nbsp;&nbsp;Save</button>
